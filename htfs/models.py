...
class Stop(models.Model):
   ...
   stop_osm_node_id = models.IntegerField(max_length=15, null=True)
...
class Route(models.Model):
   ...
   agency_route_duration = models.IntegerField(null=True, help_text='Travel time in minutes')
   route_osm_relation_id = models.IntegerField(max_length=10, null=True)
...
class Trip(models.Model):
   ...
   shape_id = models.ForeignKey('Shape', null=True)
   carrier_id = models.ForeignKey('Carrier', null=True)
...
class FareRule(models.Model):
   fare_id = models.AutoField(primary_key=True)
   route_id = models.ForeignKey('Route', null=True)
   origin_id = models.IntegerField(null=True)
   destination_id = models.IntegerField(null=True)
   contains_id = models.IntegerField(null=True)
...
class Carrier(models.Model):
   ...
   standing_capacity = models.IntegerField(null=True)
